...
::: moniker range="visualstudio"
![Screenshot that shows a test list in Test Explorer.](../test/media/visualstudio/test-explorer-17-0.png)
::: moniker-end
...
::: moniker range="visualstudio"
:::image type="content" source="../test/media/visualstudio/test-explorer-toolbar-diagram-17-0.png" alt-text="Diagram that describes icons for running tests from the Test Explorer toolbar.":::
::: moniker-end
...
::: moniker range="visualstudio"
![Screenshot of test execution details.](../test/media/visualstudio/test-explorer-details.png)
::: moniker-end
...
![Screenshot showing selections for grouping tests by category in Test Explorer.](../test/media/visualstudio/test-explorer-group-by-17-0.png)
...
![Screenshot of Test Explorer that shows a test hierarchy on one pane and the Group By menu on the other pane. The Class and State options are selected.](../test/media/visualstudio/test-explorer-group-by-state-17-0.png)
::: moniker-end
...
![Screenshot that shows selections for creating a playlist.](../test/media/visualstudio/test-explorer-playlist-17-0.png)
...
![Screenshot that shows a playlist opened on a separate Test Explorer tab.](../test/media/visualstudio/test-explorer-playlist-tab-17-0.png)
...
- On the toolbar, select the **Edit Playlist** button. Checkboxes that appear next to your tests show what tests are included and excluded in the playlist. Edit groups as desired. This capability started in Visual Studio 2019 version 16.7.
  ...
  ![Screenshot that shows a list of tests with checkboxes to include them a playlist.](../test/media/visualstudio/test-explorer-playlist-edit-17-0.png)
...
![Screenshot that shows the contents of a playlist XML file.](../test/media/visualstudio/test-explorer-playlist-xml-file.png)
...
![Screenshot of Visual Studio Test Explorer that shows a menu with Columns selected and a submenu with Duration, Traits, and Error Message selected.](../test/media/visualstudio/test-explorer-columns-17-0.png)
...
- To filter to specific traits, select the filter icon at the top of the **Traits** column.
  ...
  ![Screenshot of the column filter.](../test/media/visualstudio/test-explorer-filter-column-17-0.png)
...
- To sort a column, select the column header. Not all columns can be sorted. You can also sort by a secondary column by holding the Shift key and selecting an additional column header.
  ...
  ![Screenshot of a column sort.](../test/media/visualstudio/test-explorer-sort-column-17-0.png)
::: moniker-end
...
::: moniker range="visualstudio"
![Screenshot of filtering tests in Test Explorer.](../test/media/visualstudio/test-explorer-search-filter-17-0.png)
::: moniker-end
