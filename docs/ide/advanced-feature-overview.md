...
[ASP.NET Core](https://dotnet.microsoft.com/learn/aspnet/what-is-aspnet-core) and [.NET](/dotnet/core/) run on Windows, macOS, and Linux. ASP.NET Core is designed to provide a lean and composable .NET stack for building modern cloud-based web apps and services.
...
- [.NET](/dotnet/core/) apps that run on Windows, macOS, and Linux.
...
[SQL Server Data Tools (SSDT)](/sql/ssdt/download-sql-server-data-tools-ssdt) is a powerful development environment for SQL Server, Azure SQL Database, and Azure Synapse Analytics dedicated SQL pools. With SSDT, you can build, debug, maintain, and refactor databases. You can work with a database project, or directly with a connected database instance on- or off-premises. To get SSDT, use the Visual Studio Installer to install the **Data storage and processing** workload.
...
Visual Studio offers [testing](../test/improve-code-quality.md) options like unit testing, Live Unit Testing, and IntelliTest. For load and performance testing scenarios, use [Azure Load Testing](https://azure.microsoft.com/services/load-testing/). Visual Studio also has modern [code analysis](../code-quality/roslyn-analyzers-overview.md) capabilities to find design, security, and other flaws.

## Deploy your finished application

Visual Studio has tools to deploy your app to users or customers through options such as Azure, Microsoft Store, ClickOnce, and Windows Installer technologies. You can access these options through the Visual Studio IDE. For more information, see [Deploy applications, services, and components](../deployment/deploying-applications-services-and-components.md).
...
- [VisualStudio.Extensibility](../extensibility/visualstudio.extensibility/visualstudio-extensibility.md)
- [Roslyn](https://github.com/dotnet/Roslyn)
- [Visual Studio IDE overview](../get-started/visual-studio-ide.md)
- [What's new in Visual Studio docs](whats-new-visual-studio-docs.md)
