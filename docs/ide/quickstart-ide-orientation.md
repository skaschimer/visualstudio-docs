...
:::image type="content" source="media/visualstudio/quickstart-start-window-labeled.png" border="true" alt-text="An annotated screenshot that shows the start window in Visual Studio." lightbox="media/visualstudio/quickstart-start-window-labeled.png":::
:::moniker-end
...
1. Start Visual Studio and select **Create a new project**.
    ...
    :::image type="content" source="media/visualstudio/start-window-create-new-project.png" alt-text="Screenshot of the 'Create a new project' window in Visual Studio." lightbox="media/visualstudio/start-window-create-new-project.png":::
...
1. In the **Create a new project** window, type **console** in the search box to filter the list of project types. Further refine the search results by picking **C#** (or another language of your choice) from the **All languages** drop-down list.
    ...
    :::image type="content" source="media/vs-2022/create-new-project.png" alt-text="Screenshot of the 'Create a new project' window in Visual Studio, where you select the template that you want." lightbox="media/vs-2022/create-new-project.png":::
...
1. In the **Configure your new project** window, accept the default project name and location, and then select **Next**.
    ...
    :::image type="content" source="media/visualstudio/quickstart-configure-new-project-console.png" alt-text="Screenshot of the Configure a new project window in Visual Studio, where you enter the name of the project and the project location." lightbox="media/visualstudio/quickstart-configure-new-project-console.png":::

1. In the **Additional information** window, ensure that **.NET 10.0** appears in the **Framework** dropdown menu, and then select **Create**.

    :::image type="content" source="media/visualstudio/create-project-additional-info.png" alt-text="Screenshot of the Additional information window in Visual Studio, where you select the version of the .NET that you want." lightbox="media/visualstudio/create-project-additional-info.png":::
...
* You can browse the hierarchy and select a file to open it in the **Editor**.
  The file *Program.cs* opens in the **Editor** window. The **Editor** shows the contents of files and is where you do most of your coding work in Visual Studio.
    ...
    :::image type="content" source="media/visualstudio/editor.png" alt-text="Screenshot of the Editor in Visual Studio." lightbox="media/visualstudio/editor.png":::
...
* The menu bar along the top of Visual Studio groups commands into categories. For example, the **Project** menu contains commands related to the project you're working in. On the **Tools** menu, you can customize how Visual Studio behaves by selecting **Options**, or add features to your installation by selecting **Get Tools and Features**. You can [customize Visual Studio IDE settings](personalizing-the-visual-studio-ide.md) in various ways to best support your own development style and requirements.
    ...
    :::image type="content" source="media/visualstudio/menu-bar.png" alt-text="Screenshot of the Menu bar in Visual Studio." lightbox="media/visualstudio/menu-bar.png":::
...
* If you run into any problems while using Visual Studio, or if you have suggestions for how to improve the product, you can let us know by choosing the **Send Feedback** button near the upper-right corner of the IDE.
    ...
    :::image type="content" source="media/visualstudio/quickstart-ide-send-feedback.png" alt-text="Screenshot of the Send Feedback button and menu in Visual Studio.":::
:::moniker-end
...
:::moniker range="visualstudio"
:::image type="content" source="media/visualstudio/quickstart-build-output-minimal.png" alt-text="Screenshot of the Output window in Visual Studio showing output messages from building your project and from your source control provider." lightbox="media/visualstudio/quickstart-build-output-minimal.png":::
:::moniker-end
...
1. Select the **Start Debugging** button (green arrow) in the toolbar or press **F5** to run your app.
    ...
    :::moniker range="visualstudio"
    :::image type="content" source="media/visualstudio/ide-tour-menu-run-app-button.png" alt-text="Screenshot of the Start Debugging button in the debug toolbar." lightbox="media/visualstudio/ide-tour-menu-run-app-button.png":::
    :::moniker-end
...
1. Select the **Start Debugging** button (green arrow) in the debug toolbar in Visual Studio to run your app.
    ...
    :::image type="content" source="media/visualstudio/ide-tour-menu-run-app-button.png" alt-text="Screenshot of the Start Debugging button on the debug toolbar." lightbox="media/visualstudio/ide-tour-menu-run-app-button.png":::

1. Use **Hot Reload** to fix issues or make changes to the code on the fly and see the results without restarting the app.

    :::image type="content" source="media/visualstudio/ide-tour-menu-hot-reload.png" alt-text="Screenshot of the Hot Reload button in the debug toolbar." lightbox="media/visualstudio/ide-tour-menu-hot-reload.png":::

1. You can stop the app at any time by selecting the **Stop** button in the toolbar.
    
    :::image type="content" source="media/visualstudio/ide-tour-menu-stop-app-button.png" alt-text="Screenshot of the Stop button in the debug toolbar." lightbox="media/visualstudio/ide-tour-menu-stop-app-button.png":::
...
1. Select the **Start Debugging** button (green arrow) in the debug toolbar in Visual Studio to run your app.
    ...
    :::image type="content" source="media/vs-2022/ide-tour-menu-run-app-button.png" alt-text="Screenshot of the Start Debugging button on the debug toolbar.":::
