...
1. Select the **Sign in** icon in the upper-right corner of the Visual Studio environment.
   ...
   :::image type="content" source="../ide/media/visualstudio/signing-in-to-visual-studio/sign-in-icon-ide.png" alt-text="Screenshot of Sign in icon in the Visual Studio IDE.":::
