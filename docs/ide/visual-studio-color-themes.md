...
Visual Studio offers a variety of color themes to personalize your development environment. Choose a theme that matches your preference, reduces eye strain, or simply adds personality to your IDE.
...
## Color themes based on the Light theme

The following color themes are variations of the Light theme.
...
## Color themes based on the Dark theme

The following color themes are variations of the Dark theme.
...
You can download more color themes at the [Visual Studio Marketplace](https://marketplace.visualstudio.com/search?term=color%20theme&target=VS&category=All%20categories&vsVersion=vs2026&sortBy=Relevance).

## Related content

- [Configure Visual Experience options](configure-visual-experience-options.md)
- [Change fonts, colors, and themes in Visual Studio](how-to-change-fonts-and-colors-in-visual-studio.md)
