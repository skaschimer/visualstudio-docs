...
- Squiggles and [Quick Actions](../../ide/quick-actions.md)
   ...
   *Squiggles* are wavy underlines that alert you to errors or potential problems in your code as you type. These visual clues help you fix problems immediately, without waiting to discover errors during build or runtime. If you hover over a squiggle, you see more information about the error. A light bulb might also appear in the left margin showing *Quick Actions* you can take to fix the error.
   ...
   ::: moniker range=">=vs-2022"
   :::image type="content" source="../media/vs-2022/squiggles-error.png" alt-text="Screenshot showing squiggles in Visual Studio.":::
   ::: moniker-end
...
- Code Cleanup
   ...
   :::image type="content" source="../media/vs-2022/code-cleanup.png" alt-text="Screenshot showing the Code Cleanup icon and menu in Visual Studio.":::
   ::: moniker-end
...
- [Refactoring](../../ide/refactoring-in-visual-studio.md)
   ...
   ::: moniker range=">=vs-2022"
   :::image type="content" source="../media/vs-2022/refactoring-menu.png" alt-text="Screenshot that shows Refactoring in Visual Studio.":::
   ::: moniker-end
...
- [IntelliSense](../../ide/using-intellisense.md)
   ...
   ::: moniker range=">=vs-2022"
   :::image type="content" source="../media/vs-2022/intellisense-list-members.png" alt-text="Screenshot that shows an IntelliSense member list.":::
   ::: moniker-end
...
- [Visual Studio search](../../ide/visual-studio-search.md)
   ...
   :::image type="content" source="../media/vs-2022/quick-launch-nuget.png" alt-text="Screenshot that shows the Quick Launch search box in Visual Studio.":::
...
- [Call Hierarchy](../../ide/reference/call-hierarchy.md)
   ...
   ::: moniker range=">=vs-2022"
   :::image type="content" source="../media/vs-2022/call-hierarchy-csharp-expanded.png" alt-text="Screenshot that shows the Call Hierarchy window.":::
   ::: moniker-end
...
- [CodeLens](../../ide/find-code-changes-and-other-history-with-codelens.md)
   ...
   ::: moniker range=">=vs-2022"
   :::image type="content" source="../media/vs-2022/codelens-overview.png" alt-text="Screenshot that shows CodeLens.":::
   ::: moniker-end
...
- [Go To Definition](../../ide/go-to-and-peek-definition.md)
   ...
   ::: moniker range=">=vs-2022"
   :::image type="content" source="../media/vs-2022/go-to-definition-menu.png" alt-text="Screenshot that shows the Go to Definition menu item.":::
   ::: moniker-end
...
- [Peek Definition](../../ide/how-to-view-and-edit-code-by-using-peek-definition-alt-plus-f12.md)
   ...
   ::: moniker range=">=vs-2022"
   :::image type="content" source="../media/vs-2022/peek-definition.png" alt-text="Screenshot showing a Peek Definition window.":::
   ::: moniker-end
...
1. Choose **Create a new project**.
   ...
   :::image type="content" source="../media/vs-2022/create-new-project.png" alt-text="Screenshot of the Visual Studio start menu with Create a new project selected.":::
...
1. To find a template, you can type or enter keywords in the search box. The list of available templates filters based on the keywords you enter. You can further filter the template results by choosing **C#** from the **All languages** dropdown list, **Windows** from the **All platforms** list, and **Console** from the **All project types** list.
   ...
   :::image type="content" source="../media/vs-2022/start-window-create-new-project.png" alt-text="Screenshot of the Create a new project window with Console Application selected.":::
...
1. Select the light bulb icon to show the available [Quick Actions](../../ide/quick-actions.md). Select **Rename 'name' to 'username'**.
   ...
   ::: moniker range=">=vs-2022"
   :::image type="content" source="../media/vs-2022/rename-quick-action.png" alt-text="Screenshot that shows the Rename action in Visual Studio.":::
   ::: moniker-end
...
1. Now take a look at IntelliSense. Below the line that says `Console.WriteLine($"\nHello {username}!");`, type `DateTime now = DateTime.`.
   ...
   ::: moniker range=">=vs-2022"
   :::image type="content" source="../media/vs-2022/intellisense-list-members.png" alt-text="Screenshot that shows IntelliSense list members in Visual Studio." lightbox="../media/vs-2022/intellisense-list-members.png":::
   ::: moniker-end
...
1. Select the screwdriver icon to see available suggestions from Visual Studio. This case shows the [Inline temporary variable](../../ide/reference/inline-temporary-variable.md) refactoring to remove a line of code without changing the overall code behavior.
   ...
   ::: moniker range=">=vs-2022"
   :::image type="content" source="../media/vs-2022/inline-temporary-variable-refactoring.png" alt-text="Screenshot showing the Inline temporary variable suggestion in Visual Studio.":::
   ::: moniker-end
...
1. Hover your mouse over the `username` variable to see its value. You can also right-click on `username` and select **Add Watch** to add the variable to the **Watch** window, where you can also see its value.
   ...
   ::: moniker range=">=vs-2022"
   :::image type="content" source="../media/vs-2022/debugging-variable-value.png" alt-text="Screenshot that shows a variable value during debugging in Visual Studio.":::
   ::: moniker-end
