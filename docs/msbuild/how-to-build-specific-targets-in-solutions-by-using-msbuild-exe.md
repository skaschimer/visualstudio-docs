...
1. At the command line, change directory to the solution folder and type `MSBuild.exe <SolutionName>.sln` (or `.slnx` as appropriate), but don't hit enter yet. Use your solution name.
