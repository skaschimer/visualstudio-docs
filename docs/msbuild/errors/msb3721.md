...
The related diagnostic verbosity settings can be configured in the Visual Studio IDE. In the **Tools** > **Options** pane, expand the **All Settings** > **Projects and Solutions** > **Build and Run** section, and set the **MSBuild project build output verbosity** and **MSBuild project build log file verbosity** options to **Diagnostic**. For more information, see [View, save, and configure build log files](../../ide/how-to-view-save-and-configure-build-log-files.md#specify-data-verbosity-for-build-logs).
