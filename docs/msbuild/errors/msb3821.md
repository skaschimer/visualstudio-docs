...
Visual Studio also includes security restrictions that detect the *mark of the web* comment. You can customize trust settings in the **Tools** > **Options** pane in the **All Settings** > **Environment** > **Security** > **Trust** section. For more information, see [Configure trust settings for files and folders](../../ide/reference/trust-settings.md).

:::moniker-end
:::moniker range="<=vs-2022"

Visual Studio also includes security restrictions that detect the *mark of the web* comment. You can customize trust settings in the **Tools** > **Options** dialog in the **Environment** > **Security** section. For more information, see [Configure trust settings for files and folders](../../ide/reference/trust-settings.md).
