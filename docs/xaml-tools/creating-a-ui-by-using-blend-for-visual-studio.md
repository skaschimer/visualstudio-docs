...
Blend for Visual Studio is a component of Visual Studio. To install Blend, in the **Visual Studio Installer** choose either the **WinUI application development** or **.NET desktop development** workload. Both of these workloads include the Blend for Visual Studio component.

![Screenshot that shows WinUI workload components.](media/visualstudio/installer-uwp.png)&nbsp;&nbsp;&nbsp;&nbsp;![Screenshot that shows .NET desktop development workload components.](media/visualstudio/installer-dotnet-desktop.png)
...
![Tools panel in Blend for Visual Studio](media/visualstudio/blend-tools-panel.png)
...
>
> ![Shape tool variations in Blend for Visual Studio](media/visualstudio/blend-rectangle-tool-variations.png)
...
![Assets window in Blend for Visual Studio](media/visualstudio/blend-assets-window.png)
...
![Object and Timeline window in animation mode](media/visualstudio/storyboard-timeline.png)
