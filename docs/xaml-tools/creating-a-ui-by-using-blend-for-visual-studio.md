...
![Screenshot that shows the Tools panel in Blend for Visual Studio.](media/visualstudio/blend-tools-panel.png)
...
>
> ![Screenshot that shows the panel tool variations in Blend for Visual Studio.](media/visualstudio/blend-rectangle-tool-variations.png)
