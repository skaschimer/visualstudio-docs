...
When you select **Options** on the **Tools** menu, the **Options** pane opens. The categories of settings accessible from this pane are collectively referred to as _options pages_.

The left portion of the pane provides navigation for top-level categories (or sections) and their subsections. Each section and subsection is an options page. The specific options or settings display in the right portion of the pane. On the options pages, you can change the values for options and settings that determine the state of a VSPackage.

:::moniker-end
:::moniker range="<=vs-2022"
      
When you select **Options** on the **Tools** menu, the **Options** dialog opens. The categories of settings accessible from this dialog are collectively referred to as _options pages_.

The left portion of the dialog provides navigation for top-level categories (or sections) and their subsections. Each section and subsection is an options page. The specific options or settings display in the right portion of the dialog. On the options pages, you can change the values for options and settings that determine the state of a VSPackage.
...
## Tools/Options Page Attributes and Layout
 The <xref:Microsoft.VisualStudio.Shell.ProvideOptionPageAttribute> attribute determines the grouping of custom options pages into categories in the **Options** navigation tree. The <xref:Microsoft.VisualStudio.Shell.ProvideOptionPageAttribute> attribute associates an options page with the VSPackage that provides the interface. Consider the following code fragment:
...
:::code language="csharp" source="../../snippets/csharp/VS_Snippets_VSSDK/vssdksupportforoptionspages/cs/vssdksupportforoptionspagespackage.cs" id="Snippet2":::
 ...
 This declares that MyPackage provides two options pages, OptionsPageGeneral and OptionsPageCustom. Under **Options**, both options pages appear in the **My Option Pages** category as **General** and **Custom**, respectively.
...
- <xref:System.ComponentModel.DescriptionAttribute> determines the description of the option.
  ...
  The OptionInteger option appears on the options page as **Integer Option** in the **My Options** category. If the option is selected, the description box contains the description, **My integer option**.
