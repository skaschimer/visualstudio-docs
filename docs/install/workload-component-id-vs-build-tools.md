...
To install these components by using the manual installer, download and run the [Build Tools for Visual Studio](https://visualstudio.microsoft.com/downloads/#build-tools-for-visual-studio-2026).

[!INCLUDE[Visual Studio Build Tools 2026](includes/vs-2026/workload-component-id-vs-build-tools.md)]
