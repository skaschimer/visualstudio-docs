...
**Updated for the [17.14 release](/visualstudio/releases/2022/release-notes/)**
...
| **Edition** | **ID** | **Description** |
| ----------- | ------ | --------------- |
| [Visual&nbsp;Studio Enterprise&nbsp;2026](workload-component-id-vs-enterprise.md?view=vs-2026&preserve-view=true) | Microsoft.VisualStudio.Product.Enterprise | Microsoft DevOps solution for productivity and coordination across teams of any size |
| [Visual&nbsp;Studio Professional&nbsp;2026](workload-component-id-vs-professional.md?view=vs-2026&preserve-view=true) | Microsoft.VisualStudio.Product.Professional | Professional developer tools and services for small teams |
...
> [!NOTE]
> For a list of the workload and component IDs for the previous version, see [Visual Studio 2022 workload and component IDs](workload-and-component-ids.md?view=vs-2022&preserve-view=true)
