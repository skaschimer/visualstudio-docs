...
> [!TIP]
> You can also use the [GitHub Copilot Profiler Agent](../profiling/profile-with-copilot-agent.md) to get AI-driven guidance for collecting and analyzing memory traces.
...
6. To take a snapshot at the start of your debugging session, choose **Take snapshot** on the **Memory Usage** summary toolbar. (It may help to set a breakpoint here as well.)
     ...
     ![Screenshot of the Memory Usage summary toolbar with the Take Snapshot button.](../profiling/media/vs-2022/dbgdiag-mem-mixed-toolbar-take-snapshot.png)
...
![Screenshot of the Memory Usage summary table showing two snapshots with columns for Objects, Heap Size, and their differences.](../profiling/media/vs-2022/dbgdiag-mem-summary-table.png)
...
- Choose the change link in a cell of the summary table of the **Memory Usage** tab on the **Diagnostic Tools** window.
   ...
   ![Screenshot of the Memory Usage summary table with the change link highlighted in a snapshot cell.](../profiling/media/vs-2022/dbgdiag-mem-choose-diff-report.png)
...
In this tutorial, you've learned how to collect and analyze memory usage data while debugging. Here are some suggested next steps:

- To analyze memory usage in release builds, see [Analyze memory usage in the Performance Profiler](../profiling/memory-usage-without-debugging2.md).
- To learn a general approach to optimizing code using the profiling tools, see [Case study: Beginner's guide to optimizing code](../profiling/optimize-code-using-profiling-tools.md).
- To get AI-driven profiling guidance, see [Profile your app with GitHub Copilot Profiler Agent](../profiling/profile-with-copilot-agent.md).
- For an overview of all profiling tools, see [First look at profiling tools](../profiling/profiling-feature-tour.md).
