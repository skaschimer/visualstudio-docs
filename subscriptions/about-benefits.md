...
The benefits included in your subscription depend on your subscription type. To see which benefits are available for different subscription levels, visit:  
https://visualstudio.microsoft.com/vs/benefits/. You can filter the view by subscription level or by benefit category.

Each benefit article in our learn documentation website includes an **Eligibility** section that identifies which subscription levels include that benefit.
...
When you visit <https://my.visualstudio.com/benefits>, all benefits appear by default. Use the category filter to narrow the list to the benefits you want to review.
...
**Why don’t I see a benefit I expected?**  
A: Benefit availability might change over time, and some benefits apply only to certain subscription levels.

**Where do I activate my benefits?**  
A: You can view and activate benefits at https://my.visualstudio.com/benefits.

**Do partner benefits renew automatically?**  
A: Some do, others don’t. Check each benefit’s documentation for renewal details.
