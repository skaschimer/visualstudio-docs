...
1. After the user selects **"Activate"** in the Subscriber portal, they're redirected to Syncfusion’s website.
    ...
    :::image type="content" source="_img/syncfusion/enterprise-activation-landing-page.png" alt-text="Screenshot of Syncfusion activation landing page with Welcome Visual Studio Subscribers heading and Activation Benefit Now button highlighted.":::

2. After the user selects the **"Activation Benefit Now"** button, they must accept Syncfusion's **Terms and Conditions**.

    :::image type="content" source="_img/syncfusion/enterprise-terms-tile.png" alt-text="Screenshot of Syncfusion's Terms and Conditions highlighted":::
...
4. If an existing Syncfusion account is available, sign in. Otherwise, select **"Create an account"**.
    ...
    :::image type="content" source="_img/syncfusion/enterprise-sign-in.png" alt-text="Screenshot of the Sign in screen with fields highlighted":::
...
5. Enter the verification code to continue.
    ...
    :::image type="content" source="_img/syncfusion/bold-sign-enter-code.png" alt-text="Screenshot of BoldSign ener 6-digit code from email":::
...
2. **Terms and Conditions** must be accepted **before activating the benefit** on their website.
    ...
    :::image type="content" source="_img/syncfusion/ui-edition-activation-landing-page.png" alt-text="Screenshot of the Essential Studio UI Edition activation page wit the Activate and Terms and Conditions highlighted.":::
...
4. If a Syncfusion account already exists, sign in. Otherwise, select **"Create an account"**.
    ...
    :::image type="content" source="_img/syncfusion/ui-edition-sign-in-page.png" alt-text="Screenshot of Essential Studio UI Edition Sign in screen highlighted.":::
