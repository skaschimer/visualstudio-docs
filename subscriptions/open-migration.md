...
This scenario applies to new partners who placed new Open License orders, but who aren't registered on the [Microsoft 365 Admin Center](https://admin.cloud.microsoft/) and go directly to the [Visual Studio Subscriptions Admin Portal](https://manage.visualstudio.com). Follow these steps:
...
> [!NOTE]
> The customer receives a notification email informing them that a Partner has been added to the Open License. They can choose to remove the Partner’s access.

## New partners who register on the Microsoft 365 Admin Center

This scenario applies to new partners placing new Open License orders but who register on the [Microsoft 365 Admin Center](https://admin.cloud.microsoft/) through the add-open flow before attempting to access the Visual Studio [Subscriptions Admin Portal](https://manage.visualstudio.com). Partners should follow these steps:
1. Sign in to the Microsoft 365 Admin Center and navigate to the **Relationship Summary**.
