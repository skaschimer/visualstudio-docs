...
2. Locate the CODE Magazine tile in the Professional Development section of the Benefits portal, and select **Activate**.
   ...
   > ![CODE Magazine Tile](_img/vs-code-magazine/code-magazine-tile-revised.png "Screenshot of the CODE Magazine tile. Activate button is highlighted.")
...
4. Based on your selections, you see a note showing the price of your subscription along with the amount of the coupon that was applied.
   ...
   > [!div class="mx-imgBorder"]
   > ![CODE Magazine subscription details](_img/vs-code-magazine/code-magazine-details-revised.png "Screenshot of Choose Your Subscription Details dialog. Available options for subscriptions are displayed. The price is listed as 'free'.")
...
7. You can opt in to CODE HTML Newsletter by selecting the check box.
   > [!div class="mx-imgBorder"]
   > ![CODE Magazine subscriber information](_img/vs-code-magazine/code-magazine-subscriber-information-revised.png "Screenshot of Subscriber information and delivery address dialog.")
