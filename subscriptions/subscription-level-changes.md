...
For information about which version of Visual Studio is included in your subscription, see the [Visual Studio Subscriptions and Benefits](https://visualstudio.microsoft.com/vs/benefits/) page. To learn about the differences between the editions included in your subscription, see the [Compare Visual Studio Editions](https://visualstudio.microsoft.com/vs/compare/) page.
